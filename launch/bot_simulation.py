...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, 'resource', 'turtlebot3_world.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'resource', 'nav2_params.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(
            bringup_dir, 'resource', 'nav2_default_view.rviz'),
    ...
    urdf = os.path.join(bringup_dir, 'resource', 'turtlebot3_waffle.urdf')
